...
// stop bots creating sessions
	...
	this.datasources[ getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_DATASOURCE' ) ] = {
// required
		 type: getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_DRIVER' )
		,host: getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_HOST' )
		,port: getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_PORT' )
		,database: getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_SCHEMA' )
		,username: getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_USER' )
		,password: getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_PASSWORD' )
// optional
	...
	this.datasource = getProfileString( expandPath( '../.ini' ), 'datasource', 'DB_DATASOURCE' );
